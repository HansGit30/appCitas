...
<div class="container-fluid min-vh-100 p-0 m-0" style="margin-top: -1.5rem !important;">
    <div class="row g-0 min-vh-100">
        ...
        <div class="col-lg-6 d-none d-lg-flex flex-column justify-content-between p-5 text-white position-relative overflow-hidden" 
             style="background: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.1)), url('{{ asset('sl.jpg') }}') center/cover no-repeat; border-radius: 0 30px 30px 0;">
        </div>
        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-center bg-white py-5 px-4 px-sm-5">
            <div class="w-100" style="max-width: 400px;">
                ...
                <div class="text-center mb-4">
                    ...
                    <h3 class="fw-bold text-dark mt-4 mb-1" style="font-size: 1.75rem;">Iniciar sesión</h3>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="mt-4">
                    ...
                    <div class="mb-3 position-relative">
                        <label for="email" class="form-label text-secondary small fw-bold mb-1">{{ __('Email Address') }}</label>
                    ...
                    <div class="mb-3">
                        <label for="password" class="form-label text-secondary small fw-bold mb-1">{{ __('Password') }}</label>
                        <div class="input-group">
                            <input id="password" type="password" class="form-control form-control-lg bg-light border-1 border-end-0 @error('password') is-invalid @enderror" 
                                   name="password" required autocomplete="current-password" 
                                   placeholder="Contraseña" style="border-radius: 10px 0 0 10px; font-size: 0.95rem;">
                            
                            <span class="input-group-text bg-light border-1 border-start-0 text-muted" style="border-radius: 0 10px 10px 0; cursor: pointer;">
                    ...
                    <div class="d-flex align-items-center justify-content-between my-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} style="border-radius: 4px;">
                        ...
                        @if (Route::has('password.request'))
                            <a class="text-decoration-none small fw-bold" href="{{ route('password.request') }}" style="color: #2B66FF;">
                    ...
                    <div class="mb-4">
                        <button type="submit" class="btn btn-primary btn-lg w-100 rounded-pill fw-bold shadow-sm" style="background-color: #2B66FF; border-color: #2B66FF; font-size: 1rem; py: 0.75rem;">
                            Ingresar
                        </button>
                    </div>
                    ...
                    <div class="position-relative text-center my-4">
                        ...
                        <span class="position-absolute top-50 start-50 translate-middle bg-white px-3 text-muted small">o ingresa con</span>
                    </div>
                    ...
                    @if (Route::has('register'))
                        <div class="text-center mt-4">
                            <span class="text-muted small">¿No tienes cuenta? <a href="{{ route('register') }}" class="fw-bold text-decoration-none" style="color: #2B66FF;">Crear cuenta</a></span>
                        </div>
                    @endif
                </form>
